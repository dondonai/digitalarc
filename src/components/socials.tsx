...
import { SITE_SOCIALS } from "@/lib/constants";

function Socials() {
  return (
    <div className="flex items-center gap-2">
      <a href={SITE_SOCIALS.facebook} rel="noopener noreferrer" target="_blank">
        <svg
      ...
      <a href={SITE_SOCIALS.shoppee} rel="noopener noreferrer" target="_blank">
        <svg
          className="ml-4 h-6 w-6 text-primary"
          fill="currentColor"
          height="24"
